...
hfiles3=extent_server_cache.h extent_client_cache.h
hfiles4=extent_server_cache.h extent_client_cache.h
...
ifeq ($(LAB4GE),1)
  yfs_client += extent_client_cache.cc extent_server_cache.cc  handle.cc
endif
yfs_client : $(patsubst %.cc,%.o,$(yfs_client)) rpc/$(RPCLIB)

extent_server=extent_server.cc extent_smain.cc inode_manager.cc
ifeq ($(LAB4GE),1)
  extent_server=extent_server_cache.cc handle.cc extent_smain.cc inode_manager.cc 
endif
